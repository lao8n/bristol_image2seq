...
Image2Seq Model = Encoder-Decoder with Attention (Xu et al) with MLP
...
# Image2Seq Model                                                           #
#############################################################################
class DRAKEPARALLEL(keras.Model):
  def __init__(self,
    ...
    super(DRAKEPARALLEL, self).__init__()
  ...
  def call(self, inputs, val_mode=False, dropout=False):      
    ...
    if val_mode:
      logging.debug("MODEL DRAKE PARALLEL CALL - Train mode")
    else:
      logging.debug("MODEL DRAKE PARALLEL CALL - Validation mode")
    ...
    logging.debug("MODEL DRAKE PARALLEL CALL - Step 0 - Process inputs - "
    ...
    # Logging, Debug & Assert
    logging.debug("MODEL DRAKE PARALLEL CALL - Step 1 - Reset decoder hidden "
    ...
    # Logging, Debug & Assert
    logging.debug("MODEL DRAKE PARALLEL CALL - Step 2 - Image encoding dense"
    ...
    # Logging, Debug & Assert 
    logging.debug("MODEL DRAKE PARALLEL CALL - Step 3 - Token embeddings - "
    ...
    # Logging, Debug, & Assert
    logging.debug("MODEL DRAKE PARALLEL CALL - Step 4 - Decoder inputs - "
    ...
    if val_mode:
      list_predictions = [input_tokens[:, 0]]
    for i in range(1, batch_token_seq_len):
      ...
      # Logging, Debug & Assert 
      logging.debug("MODEL DRAKE PARALLEL CALL - Step 5.1 - Attention - "
      ...
      # Logging, Debug & Assert 
      logging.debug("MODEL DRAKE PARALLEL CALL - Step 5.2 - Expand context "
      ...
      # Logging, Debug & Assert  
      logging.debug("MODEL DRAKE PARALLEL CALL - Step 5.2 - Concat context"
      ...
      # Logging, Debug & Assert
      logging.debug("MODEL DRAKE PARALLEL CALL - Step 5.3 - LSTM output - "
                    "lstm_output shape {}"
      ...
      # Logging. Debug & Assert
      logging.debug("MODEL DRAKE PARALLEL CALL - Step 5.4 - MLP output - "
      ...
      # Logging, Debug & Assert
      logging.debug("MODEL DRAKE PARALLEL CALL - Step 5.5 - "
      ...
      # Logging, Debug & Assert
      logging.debug("MODEL DRAKE PARALLEL CALL - Step 5.6 - Update decoder "
    ...
    if val_mode:
      ...
      # Logging, Debug & Assert
      # logging.debug("MODEL DRAKE PARALLEL CALL - Step 6 - Stack predictions  \n{}"
