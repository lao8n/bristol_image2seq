...
# Image2Seq Model                                                           #
#############################################################################
class DRAKECONCATMLP(keras.Model):
  def __init__(self,
    ...
    super(DRAKECONCATMLP, self).__init__()
  ...
  def call(self, inputs, val_mode=False, dropout=False):      
    ...
    if val_mode:
      logging.debug("MODEL DRAKE CONCAT MLP CALL - Train mode")
    else:
      logging.debug("MODEL DRAKE CONCAT MLP CALL - Validation mode")
    ...
    logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 0 - Process inputs - "
    ...
    # Logging, Debug & Assert
    logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 1 - RetinaNet "
    ...
    # Logging, Debug & Assert
    logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 1 - Initial hidden "
    ...
    # Logging, Debug & Assert
    logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 2 - Image encoding"
                  " dense and activations - input_image_features shape {}"
    ...
    # Logging, Debug & Assert 
    logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 3 - Token embeddings - "
    ...
    # Logging, Debug, & Assert
    logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 4 - Decoder inputs - "
    ...
    for i in range(1, batch_token_seq_len):
      ...
      # Logging, Debug & Assert 
      logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 5.1 - Attention - "
      ...
      # Logging, Debug & Assert 
      logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 5.2 - Expand "
      ...
      # Logging, Debug & Assert  
      logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 5.2 - Concat context"
      ...
      # Logging, Debug & Assert
      logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 5.3 - LSTM output - "
                    "lstm_output shape {}"
      ...
      # Logging. Debug & Assert
      logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 5.4 - MLP output - "
      ...
      # Logging, Debug & Assert
      logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 5.5 - "
      ...
      # Logging, Debug & Assert
      logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 5.6 - Update "
    ...
    if val_mode:
      ...
      logging.debug("MODEL DRAKE CONCAT MLP CALL - Step 6 - Stack "
                    "predictions shape {}"
