...
# Attention                                                                 #
#############################################################################
class AttentionMap(keras.Model):
  def __init__(self,
               input_embedding_dim,
               decoder_hidden_dim):
    ...
    # LAYER 7 = Dropout #####################################################
    self.layer7_dropout = keras.layers.Dropout(0.1)
  ...
  def call(self, inputs, dropout=False):
    ...
    if dropout:
      attention_weighted_input = \
        self.layer7_dropout(attention_weighted_input)

    return attention_weighted_input, attention_weights
